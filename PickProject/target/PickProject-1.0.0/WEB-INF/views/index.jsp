...
<link
	...
	rel="stylesheet" />
<link
	href='https://fonts.googleapis.com/css?family=Roboto:500,300,700,400'
...
<!-- 	<div class="main" ng-controller="MainController">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div align="right">
				<div>
					<a href="index?mylocale=en">English </a> | <a
...
<%-- 				<kbd>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="page-scroll" href="/PickProject/signUp"><spring:message
								code="LABEL.MENU.SIGNUP" /></a></li>
					<!-- 					<li><a class="page-scroll" data-toggle="modal" data-target=".bs-example-modal-sm">Login</a></li> -->
					<li><a class="page-scroll" href="/PickProject/user"><spring:message
								code="LABEL.MENU.LOGIN" /></a></li>
					<!-- 			<li><a class="page-scroll" href="/PickProject/admin">Admin
							Login</a></li>
					<li><a class="page-scroll" href="/PickProject/db">DBA
							Login</a></li> -->
					<!-- 					<li><a class="page-scroll" data-toggle="modal"
						data-target="#myModal">Login New</a></li> -->
					<li><a class="page-scroll" href="#printRateList"><spring:message
								code="LABEL.MENU.PHOTOPRINTS" /></a></li>
					<li><a class="page-scroll" href="#services"><spring:message
								code="LABEL.MENU.SERVICES" /></a></li>
					<li><a class="page-scroll" href="#portfolio"><spring:message
								code="LABEL.MENU.PORTFOLIO" /></a></li>
					<li><a class="page-scroll" href="#about"><spring:message
								code="LABEL.MENU.ABOUT" /></a></li>
					<li><a class="page-scroll" href="#team"><spring:message
								code="LABEL.MENU.PRINTQUALITY" /></a></li>
					<li><a class="page-scroll" href="#contact"><spring:message
		...
		<div class="container">
			<div class="intro-text">
				...
				<div class="intro-heading">
					<spring:message code="LABEL.INDEX.PICKMYCLICK" />
				</div>
				<a href="#services" class="page-scroll btn btn-xl"><spring:message
						code="LABEL.INDEX.TELLMEMORE" /></a>
			</div>
		</div>
	</header>
...
<div class="container">
 ...
 --%>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<p>
								...
								purpose. Itâs a beautiful template thatâs designed with the
	...
	<!-- Controllers -->
	<script
		src="<c:url value="/resources/js/controllers/MainController.js" />"></script>
</body>
