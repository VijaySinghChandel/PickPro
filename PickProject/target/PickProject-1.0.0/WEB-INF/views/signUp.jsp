...
<body id="page-top" class="index">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="page-scroll" href="/PickProject/signUp">Sign
							Up</a></li>
		...
		<!-- 			<li><a class="page-scroll" href="/PickProject/admin">Admin
					...
					<li><a class="page-scroll" href="#logIn">Photo
							Prints</a></li>
	...
	<section id="#logIn" class="bg-light-gray">
		...
		<div class="container" style="padding: 25px 30px;" align="left">
			<div class="login-form">
				<c:url var="loginUrl" value="/login" />
				<div class="modal-body" style="padding: 40px 50px;">
					<form:form modelAttribute="user" action="/PickProject/addUser" method="POST" class="form-horizontal">
						<div class="input-group c">
							<label for="email"><span
								class="col-sm-2 glyphicon glyphicon-user"></span> Email</label> <input
								type="text" class="form-control" id="email" name="ssoId"
								placeholder="Enter Email" required>
						</div>
						<div class="input-group c">
							<label for="psw"><span
								class="col-sm-2 glyphicon glyphicon-eye-open"></span> Password</label> <input
								type="password" class="form-control" id="password"
								name="password" placeholder="Enter Password" required>
						</div>
						<div class="input-group c">
							<label for="psw"><span
								class="col-sm-2 glyphicon glyphicon-eye-open"></span>Confirm Password</label> <input
								type="password" class="form-control" id="matchingPassword"
								name="matchingPassword" placeholder="Confirm Password" required>
						</div>
						<div class="input-group c">
							<label for="psw"><span
								class="col-sm-2 glyphicon glyphicon-phone"></span>Mobile</label> <input
